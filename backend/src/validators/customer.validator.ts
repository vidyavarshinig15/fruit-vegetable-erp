...
export const createCustomerSchema = z.object({
  ...
  pincode: z
    .string()
    .regex(pinRegex, 'Pincode must be exactly 6 digits')
    .nullable()
    .or(z.literal(''))
    .optional(),
  businessType: z
    .preprocess((val) => (val === '' ? 'Other' : val), z.enum(businessTypes, {
  ...
  paymentTerms: z.string().optional().or(z.literal('')).default('Weekly Payment'),
