...
const SEED_USERS: UserRecord[] = [
  {
    ...
    passwordHash: '$2a$12$G4h2fEko86XM7abTUcDUMu0eLYS6vAJzV7m1RVgEZvVfEepwVy.bq', // Hash for Tanjiro@123
  },
  {
    id: 'usr_test_admin',
    ...
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    passwordHash: '$2a$12$3.NgXKalcebeHUuCWwkMJuMsHCJJUvwudpU5evboGJ4pub0cQczty', // Hash for Password@123
  }
];
