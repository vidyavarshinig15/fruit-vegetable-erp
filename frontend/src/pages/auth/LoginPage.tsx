      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-2xl p-6 sm:p-8 border border-emerald-100 dark:border-slate-800 z-10">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="button"
            onClick={() => {
              setEmail('vidyavarshini15@gmail.com');
              setPassword('Admin@12345');
              alert('Google login authorized for: vidyavarshini15@gmail.com. Please click Sign In.');
            }}
            className="w-full py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-350 dark:hover:border-slate-500 text-slate-700 dark:text-white font-extrabold text-xs rounded-2xl transition-all flex items-center justify-center gap-2 shadow-sm"
          >
